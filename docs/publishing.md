...
- 当前版本：`1.3.2`；最低兼容构建：`262`；不设置 `until-build`。
...
- Marketplace `publishPlugin` 已成功；2026-09-01 11:29 CST 公共 API 显示插件 `hasUnapprovedUpdate=true`，公开更新仍为已批准并列出的 `1.1.2`。这证明 `1.3.2` 已被 Marketplace 接受但仍待 JetBrains 审核，不代表已经公开上架。
